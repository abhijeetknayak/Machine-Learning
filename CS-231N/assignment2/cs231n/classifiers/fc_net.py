...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        z1, z1_cache = affine_forward(X, self.params['W1'], self.params['b1'])
        a1, a1_cache = relu_forward(z1)
        
        z2, z2_cache = affine_forward(a1, self.params['W2'], self.params['b2'])
        scores = z2
        ...
        dx, dw, db = affine_backward(dout, z2_cache)
        grads['b2'] = db
        grads['W2'] = dw
        grads['W2'] += self.reg * W2
        
        dx = relu_backward(dx, a1_cache)
        
        dx, dw, db = affine_backward(dx, z1_cache)
        grads['b1'] = db
        grads['W1'] = dw
